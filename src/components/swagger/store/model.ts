...
export default class ObservableStore {
    ...
    groupingModel(docs) {
        ...
        //输出 { path . tags, value}
        // const pathsMap = new Map<{ path: string, tags: string[] }, any>(Object.keys(paths).map(x => {
        //     let tag = [];
        //     Object.keys(paths[x]).map(y => {
        //         tag = [...tag, ...paths[x][y].tags]
        //     });
        //     return [{ path: x, tags: [...new Set(tag)] }, paths[x]]
        // }) as any);
        // 获取 设置 mo'de'l 数据 
