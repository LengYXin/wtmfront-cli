...
![Alt text](https://raw.githubusercontent.com/LengYXin/samsundot-cli/master/docs/img/1.png)
...
![Alt text](https://raw.githubusercontent.com/LengYXin/samsundot-cli/master/docs/img/2.png)
![Alt text](https://raw.githubusercontent.com/LengYXin/samsundot-cli/master/docs/img/3.png)

>3：点击提交。提示 组件创建成功。等待重新编译完成。页面中就能看到创建的组件。
>创建完成的组件结构如下（根据模板生成）
>pageConfig.json 为swagger 解析后的数据原型
![Alt text](https://raw.githubusercontent.com/LengYXin/samsundot-cli/master/docs/img/5.png)
### 组件创建内部流程
...
![Alt text](https://raw.githubusercontent.com/LengYXin/samsundot-cli/master/docs/img/4.png)
...
![Alt text](https://raw.githubusercontent.com/LengYXin/samsundot-cli/master/docs/img/6.png)
